tinymce.addI18n("sv_SE", {
	...
	"Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
		"Din browser st\u00f6djer inte direkt \u00e5tkomst till klippboken. V\u00e4nligen anv\u00e4nd kortkommandona Ctrl+X/C/V i st\u00e4llet.",
	Headers: "Rubriker",
	"Header 1": "Rubrik 1",
	"Header 2": "Rubrik 2",
	"Header 3": "Rubrik 3",
	...
	"Focus to contextual toolbar":
		"Fokusera p\u00e5 den kontextuella verktygsraden",
	"Insert link (if link plugin activated)":
		"Infoga l\u00e4nk (om link-pluginet \u00e4r aktiverat)",
	"Save (if save plugin activated)":
		"Spara (om save-pluginet \u00e4r aktiverat)",
	"Find (if searchreplace plugin activated)":
		"S\u00f6k (om searchreplace-pluginet \u00e4r aktiverat)",
	...
	"Could not find the specified string.":
		"Kunde inte hitta den specifierade st\u00e4ngen.",
