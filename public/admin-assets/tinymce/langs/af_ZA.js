tinymce.addI18n("af_ZA", {
	...
	"Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
		"Jou webblaaier ondersteun nie toegang tot die knipbord nie. Gebruik asb. Ctrl+X/C/V",
	"Heading 4": "Opskrif 4",
	Div: "Div",
	"Heading 2": "Opskrif 2",
	Paste: "Plak",
	...
	"Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.":
		"Die plak funksie is nou in plat-teks modus. Teks word ingevoeg sonder enige formateering, todat jy hierdie opsie wissel.",
	Underline: "Onderlyn",
	Cancel: "Kanselleer",
	...
	"Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.":
		"Id moet met 'n letter begin en kan slegs deur letters, koppeltekens, syfers, punte en onderstreep-karakters gevolg word.",
	Name: "Geen",
	Anchor: "Anker",
	Id: "Id",
	"You have unsaved changes are you sure you want to navigate away?":
		"Jy het ongestoorde wysigings op hierdier bladsy - is jy seker dat jy die bladsy wil verlaat?",
	...
	"The URL you entered seems to be an external link. Do you want to add the required http:// prefix?":
		'Die URL verwys na \'n eksterne adres. Wil jy die "http://" voorvoegsel byvoeg?',
	"Paste or type a link": "Plak of tik 'n skalel in",
	Target: "Teiken",
	"The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?":
		'Die URL lyk soos \'n eposadres. Wil jy die "mailto:" voorvoegsel byvoeg?',
	...
	"Could not find the specified string.":
		"Kon nie die gesoekde string vind nie",
	Replace: "Vervang",
	Next: "Volgende",
	...
	"Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help":
		"Ryk Teks Area. Druk ALT-F9 vir menu, ALT-F10 vir die nutsbalk, ALT-0 vir hulp.",
	Tools: "Gereedskap",
	View: "Formaat",
	Table: "Tabel",
	Format: "Formateer",
