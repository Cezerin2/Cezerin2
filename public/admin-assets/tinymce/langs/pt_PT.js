tinymce.addI18n("pt_PT", {
	...
	"Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
		"O seu navegador n\u00e3o suporta acesso direto \u00e0 \u00e1rea de transfer\u00eancia. Por favor use os atalhos Ctrl+X/C/V do seu teclado.",
	Headers: "Cabe\u00e7alhos",
	...
	"Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.":
		"O comando colar est\u00e1 em modo de texto simples. O conte\u00fado ser\u00e1 colado como texto simples at\u00e9 desativar esta op\u00e7\u00e3o.",
	"Font Family": "Fonte",
	"Font Sizes": "Tamanhos",
	Class: "Classe",
	...
	"Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.":
		"O ID deve come\u00e7ar com uma letra, seguido de apenas letras, n\u00fameros, pontos, dois pontos, tra\u00e7os ou subtra\u00e7os.",
	"You have unsaved changes are you sure you want to navigate away?":
		"Existem altera\u00e7\u00f5es que ainda n\u00e3o foram guardadas. Tem a certeza que pretende sair?",
	...
	"Insert link (if link plugin activated)":
		"Inserir hiperliga\u00e7\u00e3o (se o plugin de liga\u00e7\u00f5es estiver ativado)",
	"Save (if save plugin activated)":
		"Guardar (se o plugin de guardar estiver ativado)",
	"Find (if searchreplace plugin activated)":
		"Pesquisar (se o plugin pesquisar e substituir estiver ativado)",
	...
	"The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?":
		"O URL que indicou parece ser um endere\u00e7o de email. Quer adicionar o prefixo mailto: tal como necess\u00e1rio?",
	"The URL you entered seems to be an external link. Do you want to add the required http:// prefix?":
		"O URL que indicou parece ser um endere\u00e7o web. Quer adicionar o prefixo http:// tal como necess\u00e1rio?",
	...
	"Could not find the specified string.":
		"N\u00e3o foi poss\u00edvel localizar o termo especificado.",
