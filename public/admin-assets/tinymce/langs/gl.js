tinymce.addI18n("gl", {
	...
	"Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.":
		"Neste momento o pegado est\u00e1 definido en modo de texto simple. Os contidos p\u00e9garanse como texto sen formato ata que se active esta opci\u00f3n.",
	...
	"Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.":
		"O ID debe comezar cunha letra, seguida s\u00f3 por letras, n\u00fameros, gui\u00f3ns, puntos, dos puntos ou gui\u00f3ns baixos.",
	"You have unsaved changes are you sure you want to navigate away?":
		"Ten cambios sen gardar. Confirma que quere sa\u00edr?",
	...
	"The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?":
		"O URL que introduciu semella seren un enderezo de correo. Quere engadirlle o prefixo mailto: requirido?",
	"The URL you entered seems to be an external link. Do you want to add the required http:// prefix?":
		"O URL que introduciu semella seren unha ligaz\u00f3n externa. Quere engadirlle o prefixo http:// requirido?",
	...
	"Could not find the specified string.":
		"Non foi pos\u00edbel atopar a cadea de texto especificada.",
