...
export const WISHLIST_RECEIVE = "WISHLIST_RECEIVE"
export const WISHLIST_ITEM_ADD_REQUEST = "WISHLIST_ITEM_ADD_REQUEST"
export const WISHLIST_ITEM_DELETE_REQUEST = "WISHLIST_ITEM_DELETE_REQUEST"

export const REGISTER_PROPERTIES = "REGISTER_PROPERTIES"

export const ACCOUNT_RECEIVE = "ACCOUNT_RECEIVE"

export const CART_LAYER_INITIALIZED = "CART_LAYER_INITIALIZED"

export const FORGOT_PASSWORD_PROPERTIES = "FORGOT_PASSWORD_PROPERTIES"
export const RESET_PASSWORD_PROPERTIES = "RESET_PASSWORD_PROPERTIES"

export const CHANGE_CUSTOMER_PROPERTIES = "CHANGE_CUSTOMER_PROPERTIES"
