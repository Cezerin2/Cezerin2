...
const ReadOnlyField = ({ step, name, value }) => {
  return (
    <div
      className={
        step > 1
          ? "checkout__field-preview field-preview"
          : "checkout__field-preview field-preview checkout__field-preview--stepcontacts"
      }
    >
...
class CheckoutStepContacts extends React.Component {
  ...
  setInitialValues() {
    ...
    if (Lscache.get("auth_data") !== null) {
      if (this.props.customerProperties.customer_settings.first_name) {
        this.props.initialize({
          first_name:
            this.props.customerProperties.customer_settings.first_name,
    ...
    if (isReadOnly) {
      return (
        <div className="checkout__step step">
          ...
          <div className="step__variants">
            <h3 className="step__variants-title">
              {text.shippingMethods}{" "}
              {loadingShippingMethods && <small>{text.loading}</small>}
            </h3>
            <div className="variants shipping-methods">
              {shippingMethods.map((method, index) => (
                <label
                  key={index}
                  className={
                    "input__radio variants__item shipping-method" +
                ...
                >
                  ...
                  />
                  <div className="variants__label input__label">
                    <div>
                      <div className="variants__name">{method.name}</div>
                      <div className="variants__description">
                        {method.description}
                      </div>
                    </div>
                    <span className="variants__rate">
          ...
          <div className="step__variants">
            ...
            <div className="variants payment-methods">
              {paymentMethods.map((method, index) => (
                <label
                  key={index}
                  className={
                    "input__radio variants__item payment-method" +
                ...
                >
                  ...
                  <div className="variants__label input__label">
                    ...
                    <span className="variants__logo payment-method__logo" />
                  </div>
                </label>
              ))}
            </div>
