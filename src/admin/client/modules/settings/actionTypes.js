...
export const IMPORT_SETTINGS_RECEIVE = 'IMPORT_SETTINGS_RECEIVE';
...
export const COMMERCE_SETTINGS_REQUEST = 'COMMERCE_SETTINGS_REQUEST';
export const COMMERCE_SETTINGS_RECEIVE = 'COMMERCE_SETTINGS_RECEIVE';
