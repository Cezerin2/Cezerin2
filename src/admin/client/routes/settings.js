...
import CommerceForm from 'modules/settings/commerceForm';
		...
		<div className="row row--no-gutter col-full-height">
			...
			<div className="col-xs-12 col-sm-8 col-md-9 col--no-gutter scroll col-full-height">
				<Switch>
					...
					<Route path="/admin/settings/general/commerceform" component={CommerceForm} />
					...
					<Route path="/admin/settings/import/googlespreadsheet" exact component={GoogleSpredsheet} />
